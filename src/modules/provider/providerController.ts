  ...
  create(
    ...
    const newProvider = {
      ...
      carte_contribuable: data.carte_contribuable
        ...
        : null,
      acf: data.acf ? data.acf[0].filename : null,
      plan_localisation: data.plan_localisation
        ? data.plan_localisation[0].filename
        : null,
      commerce_registre: data.commerce_registre
        ? data.commerce_registre[0].filename
        : null,
      banck_attestation: data.banck_attestation
