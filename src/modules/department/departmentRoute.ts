...
export default class DepartmentRouter {
  ...
  private config() {
    ...
    this.routes.post("/", validateData("create"), (req, res) => {
      this.departmentController
        .create(req.body)
        .then((department) =>
          res
    ...
    this.routes.get("/:id/members", validateData("get"), (req, res) => {
      this.departmentController
    ...
    this.routes.post("/:id/members", validateData("addMember"), (req, res) => {
      this.departmentController
    ...
    this.routes.get("/:id/validators", validateData("get"), (req, res) => {
      this.departmentController
